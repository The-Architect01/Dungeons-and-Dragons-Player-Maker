...
namespace Dungeons_and_Dragons_Player_Maker.Player_Maker.Customization
{
    public partial class BARBARIAN : BaseClassCustom {
        ...
        ComboBox Skill1 = new() {
            DataSource = new[] { "Select One", "Animal Handling","Athletics","Intimidation","Nature","Perception","Survival" },
            Location = new(10, 178),
            Size = new(151, 28),
            Text = "Select One"
        };
        ...
        ComboBox Equip1 = new() {
            DataSource = new[] { "Select One", "Greataxe" }.Union(Engine.MARTIAL_WEAPONS).ToList(),
            Location = new(10, 252),
            Size = new(151, 28),
            Text = "Greataxe"
        };
        ComboBox Equip2 = new() {
            DataSource = new[] { "Select One", "Handaxe" }.Union(Engine.SIMPLE_WEAPONS).ToList(),
